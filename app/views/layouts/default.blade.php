	...
	<body>
		...
		<div id="nav">
	      ...
	      <ul class="nav navbar-nav pull-right">
	      	...
	      	<li> <a data-toggle="modal" data-target="#user_model" href="{{ URL::route('users.show', $userid) }}" >Edit Profile</a></li>
		...
		<div class="modal fade" id="user_model" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
